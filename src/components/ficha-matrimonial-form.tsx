  ...
  const form = useForm<FichaMatrimonialData>({
    ...
    defaultValues: {
      marriageData: {
        ...
        civilMarriageDate: new Date("2000-05-20"),
        religiousMarriageDate: new Date("2000-06-17"),
      },
      groomData: {
        names: "Juan Carlos",
      ...
      growthLadder: [
        { name: "Diálogo", date: new Date("2011-02-12") },
        { name: "Renovación Conyugal", date: new Date("2013-08-20") },
      ],
      serverRetreats: {
        Encuentro: [{ date: new Date("2015-11-05"), role: "Coordinadores", comments: "Fue una gran experiencia" }],
        Diálogo: [],
        "Fe y Conversión": [],
        Reencuentro: [],
        "Renovación Conyugal": [],
      ...
      growthGroups: [
        { groupName: "Los Peregrinos", startDate: new Date("2019-01-15"), endDate: new Date("2020-12-15"), encounter: "165" },
      ],
